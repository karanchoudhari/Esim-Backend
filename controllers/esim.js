...
exports.sendEmailOTP = async (req, res) => {
  try {
    ...
    try {
      ...
      // Don't clear OTP immediately - allow frontend to retry
      return res.status(500).json({ 
        success: false,
        message: 'Temporary email service issue. Please try again in a moment.',
        error: process.env.NODE_ENV === 'production' ? 'Service unavailable' : emailError.message,
